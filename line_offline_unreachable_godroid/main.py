...
query_table = "fulfillment-dwh-production.pandata_report.country_TH_vendor_experience_auto_offline_unreachable"
...
pipeline_name = "line_offline_unreachable_godroid"
...
if Live == False:
    query = f"""
      ...
      WHERE DATE(vendors.report_datetime_local) = CURRENT_DATE("Asia/Bangkok")
        ...
        AND NOT vendors.is_using_go_app
      LIMIT 1
    """

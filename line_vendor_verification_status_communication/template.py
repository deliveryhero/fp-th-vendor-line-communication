            ...
            "contents":
{
  ...
  "body": {
    ...
    "contents": [
      {
        "type": "text",
        "text": "รหัสร้าน vendor_code ผูกไลน์กับ foodpanda ไม่สำเร็จ เนื่องจากข้อมูลร้านค้า หรือ เบอร์โทรศัพท์ที่กรอกมาไม่ถูกต้อง  กรุณาดำเนินการใหม่อีกครั้ง",
        "align": "center",
        "wrap": true,
        "contents": [
          {
          ...
          {
            "type": "span",
            "text": "ผูกไลน์กับ foodpanda ไม่สำเร็จ เนื่องจากข้อมูลร้านค้า หรือ เบอร์โทรศัพท์ที่กรอกมาไม่ถูกต้อง  กรุณาดำเนินการใหม่อีกครั้ง"
          }
        ]
      }
    ]
